...
func TestResolver_Resolve(t *testing.T) { //nolint:maintidx
	...
	tests := map[string]func() testcase{
		...
		// 			"t2":  h.BaseDef(),
		// 		},
		// 		base:    h.BaseWithoutRecursion("map", "t1", "t2"),
		...
		// 			"t2": h.BaseDef(),
		// 		},
		// 		base: h.BaseWithoutRecursion("t2"),
		// 		exprValidator: func(v *MockexpressionValidator) {
		// 			v.EXPECT().Validate(expr).Return(nil)
		...
		// 			"t2": h.BaseDef(),
		// 		},
		// 		base: h.BaseWithoutRecursion("t1", "t2"),
		// 		exprValidator: func(v *MockexpressionValidator) {
		// 			v.EXPECT().Validate(expr).Return(nil)
		...
		// 			"t3": h.BaseDef(),
		// 		},
		// 		base: h.BaseWithoutRecursion("t1", "t2", "t3"),
		// 		exprValidator: func(v *MockexpressionValidator) {
		// 			v.EXPECT().Validate(expr).Return(nil)
		// 			v.EXPECT().Validate(expr.Inst.Args[0]).Return(nil)
		...
		// 		base:  h.BaseWithoutRecursion("t1"),
		// 		expr:  expr,
		// 		exprValidator: func(v *MockexpressionValidator) {
		// 			v.EXPECT().Validate(expr).Return(nil)
		...
		// 		base:  h.BaseWithoutRecursion("string"),
		// 		expr:  expr,
		// 		exprValidator: func(v *MockexpressionValidator) {
		// 			v.EXPECT().Validate(expr).Return(nil)
		...
		// 		},
		// 		base: h.BaseWithoutRecursion("vec", "int"),
		// 		exprValidator: func(v *MockexpressionValidator) {
		// 			v.EXPECT().
	...
	for name, tt := range tests {
		...
		t.Run(name, func(t *testing.T) {
			...
			got, err := ts.MustNewResolver(v, c).Resolve(tc.expr, tc.scope, tc.base, ts.Trace{}) // TODO
