...
export const DefaultApiAxiosParamCreator = function (
  ...
  return {
    ...
    programGet: async (
      ...
      const localVarPath = `/program`.replace(
        `{${"path"}}`,
...
export const DefaultApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.programGet(
        path,
        options
      )
    ...
    async programPatch(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<Program>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.programPatch(
        path,
        program,
        options
      )
    ...
    async programPost(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<Program>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.programPost(
        path,
        program,
        options
      )
...
export const DefaultApiFactory = function (
  ...
  return {
    ...
    programPatch(
      ...
      return localVarFp
        .programPatch(path, program, options)
        .then(request => request(axios, basePath))
    },
    /**
     *
    ...
    programPost(
      ...
      return localVarFp
        .programPost(path, program, options)
        .then(request => request(axios, basePath))
    },
  }
}
