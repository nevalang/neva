...
// Check that program that do nothing returns 0 exit code and prints nothing.
...
// Check program prints the exact string from the stdin and exit with code 0.
...
// Check that implicit usage of struct selector lead to expected output.
...
// Check that usage of syntax sugar for struct selector lead to expected output.
